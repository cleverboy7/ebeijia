...
(function($) {
    ...
    $.alerts = {
        ...
        alert: function(message, title, callback) {
            ...
            $.alerts.interval = setInterval(function() {
                if(t==0) {
                    $("#popup_container input[type='button']").click();
                }else{
                    t=t-1;
                    $("#popup_container input[type='button']").val("确认(" + t + ")");
                }
            }, 1000);
            $("#popup_container input[type='button']").val("确认(" + t + ")");
        },
